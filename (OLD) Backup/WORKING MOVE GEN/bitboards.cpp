...
constexpr U64 UpdateCastleMasks[2][2] = {{wKing | wLeft, wKing | wRight}, {bKing | bLeft, bKing | bRight}};
constexpr U64 CastleMasks[2][2] = {{1008806316530991104, 6917529027641081856}, {14, 96}};
